...
| 도구 | 파일명 | 설명 | 공식 다운로드 |
|------|--------|------|--------------|
| **Git for Windows** | `Git-2.52.0-64-bit.exe` | Git 명령줄 도구 + Git Bash 포함. Windows에서 git 명령을 실행하려면 반드시 설치해야 합니다. | [git-scm.com/install/windows](https://git-scm.com/install/windows) |
| **TortoiseGit** | `TortoiseGit-2.18.0.1-64bit.msi` | 윈도우 탐색기에 Git 기능을 통합하는 GUI 클라이언트. 커밋·로그·diff를 마우스로 다룰 수 있어 명령줄에 익숙하지 않을 때 유용합니다. Git for Windows 설치 후 사용하세요. | [tortoisegit.org/download](https://tortoisegit.org/download/) |

> **설치 순서 (Windows):** Git for Windows → TortoiseGit 순서로 설치하세요.
> TortoiseGit은 Git for Windows를 백엔드로 사용하기 때문에 Git이 먼저 설치되어 있어야 합니다.
